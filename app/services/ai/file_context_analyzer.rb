  ...
  class FileContextAnalyzer
    ...
    def analyze_routing_structure
      ...
      
      {
        ...
        protected_routes: routes.select { |r| r[:protected] }.count,
        public_routes: routes.reject { |r| r[:protected] }.count
      }
    end
    ...
    def detect_operation_context(content, table_name)
      ...
      table_context = content[content.index(table_name) - 100, 200] rescue content
