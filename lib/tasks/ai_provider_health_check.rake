namespace :ai do
  ...
  task health_check: :environment do
    ...
    require_relative '../../scripts/test_openrouter_kimi_tool_calling.rb'
  ...
  def send_status_change_alert(old_status, new_status)
    if new_status
      message = "🎉 OpenRouter + Kimi K2 tool calling is now WORKING! Consider gradual rollout to save costs."
    else  
      message = "⚠️ OpenRouter + Kimi K2 tool calling has STOPPED working. Falling back to direct Moonshot API."
    end
